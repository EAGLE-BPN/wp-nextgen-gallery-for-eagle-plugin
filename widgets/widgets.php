...
class nggSlideshowWidget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$title = apply_filters('widget_title', empty( $instance['title'] ) ? __('', 'nggallery') : $instance['title'], $instance, $this->id_base);
	...
	function form( $instance ) {
		...
		//Defaults
		$instance = wp_parse_args( (array) $instance, array( 'title' => '', 'galleryid' => '0', 'height' => '120', 'width' => '160') );
